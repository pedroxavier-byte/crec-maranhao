          ...
          <>
            ...
            {noticia.linkUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '14px 16px', borderRadius: 10, background: cor, color: 'white', fontWeight: 700, fontSize: 15, textDecoration: 'none' }}
              >
                🔗 {noticia.linkTitulo || 'Link para inscrição'}
              </a>
            )}
          </>
        )}
